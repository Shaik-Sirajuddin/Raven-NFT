                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul className="navbar-nav ml-auto">
                                    <li className="nav-item">
                                        <Link style={{ textDecoration: 'none' }} to='/#roadmap'><a className="nav-link" href="#roadmap" data-ps2id-offset="120">Roadmap</a></Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link style={{ textDecoration: 'none' }} to='/register'><a className="nav-link" href="register" data-ps2id-offset="120">Register</a></Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link style={{ textDecoration: 'none' }} to='/presale'><a className="nav-link" href="presale" data-ps2id-offset="120">Presale</a></Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link style={{ textDecoration: 'none' }} to='/mint'><a className="nav-link" href="mint" data-ps2id-offset="120">Mint</a></Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link style={{ textDecoration: 'none' }} to='/faq'><a className="nav-link" href="raq" data-ps2id-offset="120">How To Mint</a></Link>
                                    </li>
