                ...
                <div className="row">
                    ...
                    <div className="col-md-6 align-self-center">
                        ...
                        <p className="lead text-grey">Set-up and build our community
                            ...
                            *subject to change).</p>
                            <Link to='/pre'> <a className="btn btn-primary mt-4 mx-0 js-tilt" data-gal="m_PageScroll2id" data-ps2id-offset="68" role="button" data-tilt-perspective="300" data-tilt-speed="700" data-tilt-max="24"><span>Register Now</span></a></Link>
                    </div>
